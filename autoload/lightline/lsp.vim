...
let s:error_symbol = get(g:, 'lightline#lsp#error_symbol', get(g:, 'lsp#lsp_diagnostics_signs_error.text', 'E:'))
let s:warning_symbol = get(g:, 'lightline#lsp#warning_symbol', get(g:, 'lsp#lsp_diagnostics_signs_warning.text', 'W:'))
let s:information_symbol = get(g:, 'lightline#lsp#information_symbol', get(g:, 'lsp#lsp_diagnostics_signs_information.text', 'I:'))
let s:hint_symbol = get(g:, 'lightline#lsp#hint_symbol', get(g:, 'lsp#lsp_diagnostics_signs_hint.text', 'H:'))
